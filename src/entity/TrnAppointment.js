...
const MstPatient_1 = require("./MstPatient");
var Status;
(function (Status) {
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => MstPatient_1.Patient, patient => patient.appointments, { onDelete: 'SET NULL' }),
    __metadata("design:type", MstPatient_1.Patient)
...
//# sourceMappingURL=TrnAppointment.js.map